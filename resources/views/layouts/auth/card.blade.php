    ...
    <body class="min-h-screen bg-[#0f110d] antialiased overflow-hidden">
        ...
        <div class="relative flex min-h-screen flex-col items-center justify-center gap-8 p-6">
            ...
            <div class="flex flex-col items-center gap-3 text-center">
                ...
                <h1 class="text-4xl text-[#f4f4f0] tracking-tight">Your Alcove awaits.</h1>
                <p class="text-[#8c8c82] italic text-base">"A reader lives a thousand lives before he dies."</p>
            </div>
